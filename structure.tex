...
\newcommand{\@mypartnumtocformat}[2]{%
    \setlength\fboxsep{0pt}                                             % Padding dei box
    \hskip -0.2cm
    \colorbox{mainColor!20}{%                                           % Primo box
        \strut\parbox[c][0.7cm]{1.2cm}{%
            \color{mainColor!70}\Large\sffamily\bfseries\centering#1
        }
    }%
    \hskip 0.1cm                                                        % Spazio tra i box
    \colorbox{mainColor!40}{%                                           % Secondo box
        \strut\parbox[c][0.7cm]{\linewidth-1.2cm-0.1cm-0.3cm}{%
...
\newcommand{\eserciziopy}[1]{%
    \ifsoluzioni
        \immediate\write18{python3 generate/#1.py --soluzioni > temp/#1_sol.tex}
        \input{temp/#1_sol.tex}
    \else
        \immediate\write18{python3 generate/#1.py > temp/#1.tex}
        \input{temp/#1.tex}
    \fi
}
...
\newcommand{\solution}{
    ...
    \vspace{0.15cm}
    \underline{\textbf{SOLUZIONE}}
    \vspace{0.15cm}
}

\newenvironment{esercizio}[1][0]{
